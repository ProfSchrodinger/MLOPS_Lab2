...
build_save_model_task = PythonOperator(
    ...
    op_args=[data_preprocessing_task.output, "rfmodel.sav"],
    dag=dag
)
...
trigger_lab2_flask = TriggerDagRunOperator(
...
owner_task >> load_data_task >> data_preprocessing_task >> build_save_model_task >> load_model_task >> send_email >> trigger_lab2_flask
